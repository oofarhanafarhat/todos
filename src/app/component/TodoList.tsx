...
export default function TodoList() {
  ...
  // ✅ API se tasks fetch karna (sahi structure ke sath)
  const fetchTasks = async () => {
    try {
      ...
      console.log("Fetched Data:", data); // ✅ API response check karein

      if (!Array.isArray(data)) throw new Error("Invalid data format");

      setTasks(data.filter((task) => task.game !== null)); // ✅ Null values hata dein
    } catch (error) {
